(function () {
    ...
    const _charts = {};
    var _cliChartResizeTimer = null;

    function resizeAllCliCharts() {
    ...
    function scheduleCliChartsResize() {
        if (_cliChartResizeTimer) clearTimeout(_cliChartResizeTimer);
        _cliChartResizeTimer = setTimeout(resizeAllCliCharts, 120);
    }
    ...
    function mkChart(id, cfg) {
        ...
        requestAnimationFrame(function () {
            try {
                if (_charts[id] && typeof _charts[id].resize === 'function') _charts[id].resize();
            } catch (e) { /* ignore */ }
        });
    }
    ...
    function showSection(name) {
        ...
        setTimeout(scheduleCliChartsResize, 120);
    }
