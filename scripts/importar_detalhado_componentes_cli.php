 ...
 * Traz apenas: numero, serie, ano, componente e quantidade usada (quantidade_componente + unidade).
 *
 * Uso (na pasta mypharm):
 *   php scripts/importar_detalhado_componentes_cli.php        → importa 2026
...
// Tabela só com: pedido (numero, serie, ano) + componente + quantidade usada
$pdo->exec("DROP TABLE IF EXISTS pedidos_detalhado_componentes");
